 ...
 * `Toffeeshare.tsx`) supply the copy and change nothing here.
 *
...
export interface VsPageProps {
  /** Display name of the rival, e.g. "ToffeeShare". */
  rivalName: string;
  /** Short eyebrow suffix, e.g. "Comparison · Warp vs ToffeeShare". */
  eyebrow: string;
  /** H1 text. */
  title: string;
